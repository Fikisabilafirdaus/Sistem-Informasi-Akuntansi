	...
	<section class="footer-section">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="footer-widget about-widget">
						...
						<img src="<?php echo e(asset('user/img/cards.png')); ?>" alt="">
					</div>
				</div>
				<div class="col-md-8">
					<div class="footer-widget about-widget">
		...
		<div class="social-links-warp">
			<div class="container">
				...
				<p class="text-white text-center mt-5">Copyright &copy; <?php if(date('Y') == '2019'): ?> <?php echo e(date('Y')); ?> <?php else: ?> 2019 - <?php echo e(date('Y')); ?> <?php endif; ?> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/adhiariyadi/" target="_blank">Adhi Ariyadi</a>.</p>
			</div>
		</div>
	</section>
	<!-- Footer section end -->
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
	<script src="<?php echo e(asset('user/js/jquery-3.2.1.min.js')); ?>"></script>
	<script src="<?php echo e(asset('user/js/bootstrap.min.js')); ?>"></script>
	<script src="<?php echo e(asset('user/js/jquery.slicknav.min.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('user/js/jquery.zoom.min.js')); ?>"></script>
	<script src="<?php echo e(asset('user/js/jquery-ui.min.js')); ?>"></script>
	...
	<script type="text/javascript">
	  $(".update_cart-cart").click(function (e) {
	    ...
	    $.ajax({
	      ...
	      method: "patch",
	      data: {_token: '<?php echo e(csrf_token()); ?>', id: ele.attr("data-id"), quantity: ele.parents("tr").find(".new-quantity").val()},
...
<?php /**PATH C:\xampp\htdocs\SISTEM INFORMASI PENJUALAN ONLINE\Toko-Online-Laravel\resources\views/template_frontend/footer.blade.php ENDPATH**/ ?>