...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- adminpro icon CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/adminpro-custon-icon.css')); ?>">
  <!-- meanmenu icon CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/meanmenu.min.css')); ?>">
  <!-- mCustomScrollbar CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/jquery.mCustomScrollbar.min.css')); ?>">
  <!-- animate CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/animate.css')); ?>">
  <!-- data-table CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/data-table/bootstrap-table.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/data-table/bootstrap-editable.css')); ?>">
  <!-- normalize CSS
	============================================ -->
  ...
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/form/themesaller-forms.css')); ?>">
  <!-- modals CSS
  ============================================ -->
  ...
  <!-- datapicker CSS
  ============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/datapicker/datepicker3.css')); ?>">
  <!-- colorpicker CSS
  ============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/colorpicker/colorpicker.css')); ?>">
  <!-- select2 CSS
	============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/select2/select2.min.css')); ?>">
  <!-- chosen CSS
  ============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/chosen/bootstrap-chosen.css')); ?>">
  <!-- ionRangeSlider CSS
  ============================================ -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/ionRangeSlider/ion.rangeSlider.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/ionRangeSlider/ion.rangeSlider.skinFlat.css')); ?>">
  <!-- style CSS
	============================================ -->
...
<body id="randombg">
      ...
      <div class="sparkline11-list shadow-reset mg-t-30">
        <div class="sparkline11-hd">
          <div class="main-sparkline11-hd">
            ...
            <div class="sparkline11-outline-icon">
              ...
              <span class="sparkline11-collapse-close"><a href="<?php echo e(route('profil', Auth::user()->id)); ?>"><i class="fa fa-times"></i></a></span>
            </div>
          </div>
        </div>
        <div class="sparkline11-graph">
          <div class="input-knob-dial-wrap">
            <div class="row">
              <div class="col-lg-12">
                <form action="<?php echo e(route('akun.simpan', Auth::user()->id)); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group">
                    <label>Email</label>
                    <input type="text" value="<?php echo e($user->email); ?>" autocomplete="off" name="email" class="form-control">
                  </div>
                  <?php if($user->pekerjaan): ?>
                    <div class="form-group">
                      <label>Pekerjaan</label>
                      <input type="text" value="<?php echo e($user->pekerjaan); ?>" autocomplete="off" name="pekerjaan" class="form-control">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Pekerjaan</label>
                  ...
                  <?php if($user->tanggal_lahir): ?>
                    <div class="form-group data-custon-pick" id="data_3">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name="tgl_lahir" class="form-control" value="<?php echo e(date('m/d/Y', strtotime($user->tanggal_lahir))); ?>">
                      </div>
                    </div>
                  <?php else: ?>
                    <div class="form-group data-custon-pick" id="data_3">
                  ...
                  <div class="form-group">
                    <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kelurahan" value="<?php echo e($user->kelurahan); ?>">
                          </div>
        								<?php else: ?>
                          <div class="form-group">
                            <label>Kelurahan</label>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kabupaten" value="<?php echo e($user->kabupaten); ?>">
                          </div>
        								<?php else: ?>
                          <div class="form-group">
                            <label>Kabupaten</label>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kecamatan" value="<?php echo e($user->kecamatan); ?>">
                          </div>
        								<?php else: ?>
                          <div class="form-group">
                            <label>Kecamatan</label>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="provinsi" value="<?php echo e($user->provinsi); ?>">
                          </div>
        								<?php else: ?>
                          <div class="form-group">
                            <label>Provinsi</label>
                  ...
                  <?php if($user->telepon): ?>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="telepon" value="<?php echo e($user->telepon); ?>">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Nomor Telepon</label>
  ...
  <!-- flot JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/flot/Chart.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/flot/flot-active.js')); ?>"></script>
  <!-- map JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/map/raphael.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/map/jquery.mapael.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/map/france_departments.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/map/world_countries.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/map/usa_states.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/map/map-active.js')); ?>"></script>
  <!-- data table JS
  ============================================ -->
  ...
  <!-- modal JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/modal-active.js')); ?>"></script>
  <!-- touchspin JS
  ============================================ -->
  ...
  <!-- colorpicker JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/colorpicker/jquery.spectrum.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/colorpicker/color-picker-active.js')); ?>"></script>
  <!-- datapicker JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/datapicker/bootstrap-datepicker.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/datapicker/datepicker-active.js')); ?>"></script>
  <!-- input-mask JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/input-mask/jasny-bootstrap.min.js')); ?>"></script>
  <!-- chosen JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/chosen/chosen.jquery.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/chosen/chosen-active.js')); ?>"></script>
  <!-- ionRangeSlider JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/ionRangeSlider/ion.rangeSlider.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/ionRangeSlider/ion.rangeSlider.active.js')); ?>"></script>
  <!-- rangle-slider JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/rangle-slider/jquery-ui-1.10.4.custom.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/rangle-slider/jquery-ui-touch-punch.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/rangle-slider/rangle-active.js')); ?>"></script>
  <!-- knob JS
  ============================================ -->
  <script src="<?php echo e(asset('admin/js/knob/jquery.knob.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/js/knob/knob-active.js')); ?>"></script>
  <!-- select2 JS
  ============================================ -->
...
<?php /**PATH C:\xampp\htdocs\SISTEM INFORMASI PENJUALAN ONLINE\Toko-Online-Laravel\resources\views/user/edit.blade.php ENDPATH**/ ?>